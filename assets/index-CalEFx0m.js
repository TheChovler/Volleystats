(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=n(s);fetch(s.href,a)}})();const K=1,M=[{id:"S",label:"Setter"},{id:"OH",label:"Outside"},{id:"MB",label:"Middle"},{id:"OPP",label:"Opposite"},{id:"L",label:"Libero"},{id:"DS",label:"DS"}],f=[1,2,3,4,5,6],W=[4,3,2,5,6,1],ct={4:"outside",3:"middle",2:"opposite",p:"pipe",d:"dump"},P=[4,3,2],q=[5,6,1];function Y(){return crypto.randomUUID()}function S(t){return{id:t.id,name:t.name,number:t.number,role:t.role}}function lt(t){return{1:t[2],2:t[3],3:t[4],4:t[5],5:t[6],6:t[1]}}function h(t){const e={lineup:{...t.startingLineup},setterId:t.setterId,scoreUs:0,scoreThem:0,weServe:t.weServeFirst};for(const n of t.events)ut(e,n);return e}function H(t,e){let n=!1;return e==="us"?(t.scoreUs+=1,t.weServe||(t.lineup=lt(t.lineup),t.weServe=!0,n=!0)):(t.scoreThem+=1,t.weServe&&(t.weServe=!1)),n}function ut(t,e){if(e.kind==="serve"){e.result==="ace"&&H(t,"us"),e.result==="out"&&H(t,"them");return}if(e.kind==="point"){H(t,e.winner);return}e.kind==="sub"&&(t.lineup={...t.lineup,[e.position]:e.in.id},t.setterId===e.out.id&&(t.setterId=e.in.id))}function L(t,e){const n=F(e,t.setterId),r={};for(const s of f)r[s]=S(F(e,t.lineup[s]));return{weServe:t.weServe,score:{us:t.scoreUs,them:t.scoreThem},setter:S(n),lineup:r}}function R(t){return t===2||t===3||t===4?"front":"back"}function B(t,e){for(const n of f)if(t[n]===e)return n;return null}function I(t,e,n,r){for(const s of e){const a=r.get(t[s]);if(a?.role===n)return a}}function dt(t,e){const n=e?k(e):!1;return t==="4"?n?"No front-row opposite in this rotation":"No front-row outside (OH) in this rotation":t==="3"?"No front-row middle in this rotation":t==="2"?n?"No front-row outside (OH) in this rotation":"No opposite on court":t==="p"?"No back-row outside for pipe":"Setter is not on court"}function k(t){return!t.weServe&&B(t.lineup,t.setterId)===1}function pt(t,e){return t==="p"?"pipe":t==="d"?"dump":e.role==="OH"?"outside":e.role==="MB"?"middle":e.role==="OPP"?"opposite":ct[t]}function Z(t,e,n){if(e==="d"){const a=n.get(t.setterId),i=a?B(t.lineup,a.id):null;return!a||!i?null:{hitter:a,court:R(i)}}if(e==="3"){const a=I(t.lineup,P,"MB",n);return a?{hitter:a,court:"front"}:null}const r=k(t);if(e==="4"){const a=r?"OPP":"OH",i=I(t.lineup,P,a,n);return i?{hitter:i,court:"front"}:null}if(e==="2"){if(r){const l=I(t.lineup,P,"OH",n);return l?{hitter:l,court:"front"}:null}const a=I(t.lineup,f,"OPP",n),i=a?B(t.lineup,a.id):null;return!a||!i?null:{hitter:a,court:R(i)}}const s=I(t.lineup,q,"OH",n);return s?{hitter:s,court:"back"}:null}function C(t,e,n){const r=[];for(const s of e){const a=n.get(t[s]);a&&r.push({rotationPos:s,player:a})}return r}function w(t,e){for(const n of e){const r=t.findIndex(s=>s.player.role===n);if(r>=0)return t.splice(r,1)[0]}return t.shift()}function mt(t,e){const n=C(t.lineup,P,e),r=C(t.lineup,q,e),s=(i,l)=>{if(l)return{hittingPos:i,rotationPos:l.rotationPos,player:l.player,row:R(l.rotationPos)}},a=k(t);return{4:s(4,w(n,a?["OPP"]:["OH"])),3:s(3,w(n,["MB"])),2:s(2,w(n,a?["OH"]:["OPP","S"])),6:s(6,w(r,["OH"])),1:s(1,w(r,["OPP","S"])),5:s(5,w(r,["L","MB","DS"]))}}function ft(t){return new Set(f.map(e=>t[e]))}function y(t){const e=t.sets[t.sets.length-1];if(!e)throw new Error("Match has no sets");return e}function X(t){return f.every(e=>!!t[e])}function F(t,e){const n=t.get(e);if(!n)throw new Error(`Unknown player ${e}`);return n}function ht(t){return new Map(t.map(e=>[e.id,e]))}function v(t){return`#${t.number} ${t.name}`}function A(t){return M.find(e=>e.id===t)?.label??t}const G="volleystats.roster",Q="volleystats.matches",j="volleystats.activeMatchId";function bt(){const t=localStorage.getItem(G);if(!t)return{teamName:"",players:[]};try{const e=JSON.parse(t);return!e||!Array.isArray(e.players)?{teamName:"",players:[]}:{teamName:e.teamName??"",players:e.players}}catch{return{teamName:"",players:[]}}}function vt(t){localStorage.setItem(G,JSON.stringify(t))}function $t(){const t=localStorage.getItem(Q);if(!t)return[];try{const e=JSON.parse(t);return Array.isArray(e)?e:[]}catch{return[]}}function yt(t){localStorage.setItem(Q,JSON.stringify(t))}function gt(){return localStorage.getItem(j)}function wt(t){t?localStorage.setItem(j,t):localStorage.removeItem(j)}function z(t,e){return{version:K,exportedAt:new Date().toISOString(),roster:t,matches:e}}function St(t){const e=JSON.parse(t);if(!e||e.version!==K)throw new Error("Unsupported or missing Volleystats file version");if(!e.roster||!Array.isArray(e.matches))throw new Error("Invalid Volleystats file");return e}const o={screen:"home",roster:bt(),matches:$t(),activeMatchId:gt(),setup:tt(),modal:null,reviewId:null,toast:""};let J=0,U;function tt(){return{opponent:"",lineup:{},setterId:"",weServeFirst:!0}}function p(){vt(o.roster),yt(o.matches),wt(o.activeMatchId)}function m(t){o.toast=t,window.clearTimeout(J),J=window.setTimeout(()=>{o.toast="",u()},1800),u()}function c(t){return t.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}function g(){return ht(o.roster.players)}function b(){return o.activeMatchId?o.matches.find(t=>t.id===o.activeMatchId)??null:null}function $(t){o.screen=t,o.modal=null,u()}function Ot(t){U=t,t.addEventListener("click",Dt),t.addEventListener("change",Ut),t.addEventListener("input",Ct),t.addEventListener("submit",Ft),document.addEventListener("keydown",Jt),u()}function u(){const t=o.toast?`<div class="toast" role="status">${c(o.toast)}</div>`:"";U.innerHTML=t+It()+Mt()}function It(){switch(o.screen){case"home":return kt();case"roster":return Et();case"setup":return Pt();case"live":return xt();case"matches":return Tt();case"review":return Lt()}}function Nt(){return window.matchMedia("(display-mode: standalone)").matches||"standalone"in navigator&&!!navigator.standalone}function kt(){const t=o.roster.teamName||"No team name yet",e=o.roster.players.length,n=b(),r=!Nt()&&location.protocol==="https:"?'<p class="hint"><strong>iPhone:</strong> tap Share → Add to Home Screen. Open that icon on court — no laptop, no signal.</p>':'<p class="hint">Data stays in this browser until you export. On court, use the Home Screen icon after installing from the HTTPS site.</p>';return`
  ...
  `}function Pt(){const t=g(),e=X(o.setup.lineup),n=new Set(f.map(s=>o.setup.lineup[s]).filter(Boolean)),r=f.map(s=>o.setup.lineup[s]).filter(s=>!!s).map(s=>t.get(s)).filter(s=>!!s).map(s=>`<option value="${s.id}" ${s.id===o.setup.setterId?"selected":""}>${c(v(s))}</option>`).join("");return`
    <div class="topbar">
  ...
  `}function xt(){const t=b();if(!t)return'<div class="card">No active match. <button class="btn" data-act="go-home">Home</button></div>';const e=y(t),n=h(e),r=g(),s=t.sets.filter(l=>l.completed).map(l=>{const d=h(l);return`${d.scoreUs}–${d.scoreThem}`}).join(", "),a=[...e.events].reverse().slice(0,10),i=!n.weServe||e.completed;return`
    <div class="topbar">
    ...
    <div class="scoreboard card">
      <button class="score-hit" data-act="point" data-winner="us" ${e.completed?"disabled":""}>
        <span class="muted">Us</span>
        <span class="score us">${n.scoreUs}</span>
      </button>
      <div>
        ...
        <div class="hint">Tap a score to record the point</div>
      </div>
      <button class="score-hit" data-act="point" data-winner="them" ${e.completed?"disabled":""}>
        <span class="muted">Them</span>
        <span class="score them">${n.scoreThem}</span>
      </button>
    </div>
    ${Ht(n,r,!e.completed)}
    <div class="pad">
  ...
  `}function N(t,e,n){const r=b(),s=r?y(r).completed:!0,a=Z(t,n,e),l=a&&(n==="4"||n==="2")?A(a.hitter.role):{4:"Outside",3:"Middle",2:"Opposite",p:"Pipe",d:"Dump"}[n],d=a?`${v(a.hitter)}${n==="2"||n==="d"?` · ${a.court}`:""}`:"—",E=n.toUpperCase();return`<button class="btn" data-act="set" data-zone="${n}" ${s?"disabled":""}><kbd>${E}</kbd> ${l}<span class="pad-who">${c(d)}</span></button>`}function Tt(){return`
    <div class="topbar">
      <h2>Past matches</h2>
      <button class="btn" data-act="go-home">Home</button>
    </div>
    <div class="card">
      <table>
        ...
        <tbody>${[...o.matches].reverse().map(e=>{const n=e.sets.map(s=>{const a=h(s);return`${a.scoreUs}–${a.scoreThem}`}).join(", "),r=new Date(e.createdAt).toLocaleString();return`
        <tr>
          <td>${c(r)}</td>
          <td>${c(e.opponent||"—")}</td>
          <td class="num">${c(n||"—")}</td>
  ...
  `}function Lt(){const t=o.matches.find(n=>n.id===o.reviewId);if(!t)return'<div class="card">Match not found. <button class="btn" data-act="go-matches">Back</button></div>';const e=t.sets.map(n=>{const r=h(n),s=n.events.map(a=>`<li><span>${c(et(a))}</span><span class="muted">${c(nt(a.at))}</span></li>`).join("");return`
  ...
  `}function At(t,e,n){return`
    <div class="court-wrap">
      ...
      <div class="court">${W.map(s=>{const a=t[s],i=a?e.get(a):void 0,l=["slot",i?"":"empty",n.server&&s===1?"server":"",n.setterId&&a===n.setterId?"setter":"",n.picking===s?"picking":""].filter(Boolean).join(" "),d=n.live?`data-act="open-sub" data-pos="${s}"`:`data-act="open-pick" data-pos="${s}"`;return`
      <button class="${l}" ${d}>
  ...
  `}function Ht(t,e,n){const r=mt(t,e),s=W.map(i=>{const l=r[i],d=l?.player,E=!!(l&&t.weServe&&l.rotationPos===1),ot=["slot",d?"":"empty",E?"server":"",d&&d.id===t.setterId?"setter":""].filter(Boolean).join(" "),at=n&&l?`data-act="open-sub" data-pos="${l.rotationPos}"`:"",it=d?`${c(A(d.role))} · ${l?.row}`:"";return`
      <button class="${ot}" ${at} ${n?"":"disabled"}>
        <span class="pos-num">${i}${E?" · serve":""}</span>
        <span class="who">${d?c(v(d)):"—"}</span>
        ${d?`<span class="slot-role">${it}</span>`:""}
      </button>`}).join("");return`
  ...
  `}function Mt(){const t=o.modal;if(!t)return"";if(t.type==="pick"||t.type==="sub"){const e=Rt(t.type==="sub"?t.position:void 0),n=t.type==="sub"?`Substitute ${Bt(t.position)}`:`Position ${t.position}`,r=e.map(s=>`<button class="btn btn-wide" data-act="${t.type==="sub"?"do-sub":"assign"}" data-id="${s.id}" data-pos="${t.position}">${c(v(s))} <span class="tag">${c(A(s.role))}</span></button>`).join("");return`
    ...
    </div>`}function Rt(t){const e=b(),n=new Set;if(o.screen==="setup")for(const r of f){const s=o.setup.lineup[r];s&&r!==t&&n.add(s)}else if(e){const r=h(y(e));for(const s of f)s!==t&&n.add(r.lineup[s])}return o.roster.players.filter(r=>!n.has(r.id)).sort((r,s)=>r.number-s.number)}function Bt(t){const e=b();if(!e)return`rotation ${t}`;const n=h(y(e)),r=g().get(n.lineup[t]);return r?v(r):`rotation ${t}`}function jt(){const t=b();return t?t.sets.length+1:1}function et(t){if(t.kind==="set"){const e=t.zone==="p"||t.zone==="d"?"":` from ${t.zone}`;return`Set ${t.zoneLabel}${e}${t.court?` (${t.court})`:""} → ${v(t.hitter)}`}return t.kind==="serve"?`Serve ${t.result} · ${v(t.server)}`:t.kind==="point"?`${t.winner==="us"?"Our":"Their"} point${t.rotated?" · we rotate":""}`:`Sub pos ${t.position}: ${v(t.out)} → ${v(t.in)}`}function nt(t){return new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function Dt(t){const e=t.target,n=e.closest("[data-act]");if(!n)return;const r=n.dataset.act;if(r){if(r==="close-modal"){if(n.classList.contains("modal-back")&&e.closest("[data-stop]")&&e!==n)return;o.modal=null,u();return}if(r==="go-home")return $("home");if(r==="go-roster")return $("roster");if(r==="go-matches")return $("matches");if(r==="resume")return $("live");if(r==="new-match"){o.setup=tt();const s=o.roster.players.find(a=>a.role==="S");o.setup.setterId=s?.id??"",$("setup");return}if(r==="export-all"){st("volleystats.json",z(o.roster,o.matches));return}if(r==="import"){U.querySelector("[data-act=import-file]")?.click();return}if(r==="del-player"){const s=n.dataset.id;o.roster.players=o.roster.players.filter(a=>a.id!==s),p(),u();return}if(r==="open-pick"){o.modal={type:"pick",position:Number(n.dataset.pos)},u();return}if(r==="assign"){Vt(Number(n.dataset.pos),n.dataset.id);return}if(r==="start-match"){_t();return}if(r==="open-sub"){const s=b();if(!s||y(s).completed)return;o.modal={type:"sub",position:Number(n.dataset.pos)},u();return}if(r==="do-sub"){Kt(Number(n.dataset.pos),n.dataset.id);return}if(r==="set"){x(n.dataset.zone);return}if(r==="serve"){T(n.dataset.result);return}if(r==="point"){D(n.dataset.winner);return}if(r==="undo"){rt();return}if(r==="end-set"){Wt();return}if(r==="next-set"){o.modal={type:"nextServe"},u();return}if(r==="start-next"){qt(n.dataset.serve==="us");return}if(r==="end-match"){o.modal={type:"confirmEnd"},u();return}if(r==="confirm-end"){Yt();return}if(r==="export-match"){const s=b();s&&_([s],V(s));return}if(r==="export-one"){const s=o.matches.find(a=>a.id===n.dataset.id);s&&_([s],V(s));return}if(r==="review"){o.reviewId=n.dataset.id??null,$("review");return}if(r==="del-match"){const s=n.dataset.id;o.matches=o.matches.filter(a=>a.id!==s),o.activeMatchId===s&&(o.activeMatchId=null),p(),u()}}}function Ut(t){const e=t.target,n=e.dataset.act;if(n==="player-role"){const r=e.dataset.id,s=e.value,a=o.roster.players.find(i=>i.id===r);a&&(a.role=s,p());return}if(n==="setter"){o.setup.setterId=e.value,u();return}if(n==="we-serve"){o.setup.weServeFirst=e.checked,u();return}if(n==="import-file"){const r=e,s=r.files?.[0];if(r.value="",!s)return;s.text().then(a=>{try{Zt(St(a)),m("Imported"),$("home")}catch(i){m(i instanceof Error?i.message:"Import failed")}})}}function Ct(t){const e=t.target,n=e.dataset.act;if(n==="team-name"){o.roster.teamName=e.value,p();return}n==="opponent"&&(o.setup.opponent=e.value)}function Ft(t){t.preventDefault();const e=t.target;if(e.dataset.act!=="add-player")return;const n=new FormData(e),r=Number(n.get("number")),s=String(n.get("name")??"").trim(),a=String(n.get("role")??"OH");if(!s||Number.isNaN(r)){m("Need a name and number");return}if(o.roster.players.some(i=>i.number===r)){m(`#${r} is already on the roster`);return}o.roster.players.push({id:Y(),name:s,number:r,role:a}),p(),e.reset(),u()}function Jt(t){if(o.screen!=="live"||o.modal)return;const e=t.target;if(e&&["INPUT","SELECT","TEXTAREA"].includes(e.tagName)||t.repeat)return;const n=t.key,r=n.toLowerCase();if(n==="ArrowLeft"){t.preventDefault(),D("us");return}if(n==="ArrowRight"){t.preventDefault(),D("them");return}if(r==="u"||n==="Backspace"){t.preventDefault(),rt();return}if(n==="4"||n==="3"||n==="2"){x(n);return}if(r==="p"){x("p");return}if(r==="d"){x("d");return}if(r==="i"){T("in");return}if(r==="o"){T("out");return}if(r==="a"){T("ace");return}}function Vt(t,e){for(const n of f)o.setup.lineup[n]===e&&delete o.setup.lineup[n];if(o.setup.lineup[t]=e,!o.setup.setterId||!Object.values(o.setup.lineup).includes(o.setup.setterId)){const n=g(),r=f.map(s=>o.setup.lineup[s]).map(s=>s?n.get(s):void 0).filter(s=>!!s);o.setup.setterId=r.find(s=>s.role==="S")?.id??e}o.modal=null,u()}function _t(){if(!X(o.setup.lineup)||!o.setup.setterId){m("Need a full starting 6 and a setter");return}const t={id:Y(),createdAt:new Date().toISOString(),opponent:o.setup.opponent.trim(),sets:[{setNumber:1,startingLineup:{...o.setup.lineup},setterId:o.setup.setterId,weServeFirst:o.setup.weServeFirst,events:[],completed:!1}]};o.matches.push(t),o.activeMatchId=t.id,p(),$("live")}function O(){const t=b();if(!t)return null;const e=y(t);return e.completed?(m("Set is over — start the next set"),null):{match:t,set:e}}function x(t){const e=O();if(!e)return;const n=g(),r=h(e.set),s=Z(r,t,n);if(!s){m(dt(t,r));return}e.set.events.push({kind:"set",at:new Date().toISOString(),zone:t,zoneLabel:pt(t,s.hitter),hitter:S(s.hitter),court:s.court,ctx:L(r,n)}),p(),u()}function T(t){const e=O();if(!e)return;const n=g(),r=h(e.set);if(!r.weServe){m("We are receiving — nothing to serve");return}const s=n.get(r.lineup[1]);s&&(e.set.events.push({kind:"serve",at:new Date().toISOString(),result:t,server:S(s),rotated:!1,ctx:L(r,n)}),p(),t==="ace"?m("Ace — point for us, keep serve"):t==="out"?m("Serve out — point for them"):u())}function D(t){const e=O();if(!e)return;const n=g(),r=h(e.set),s=t==="us"&&!r.weServe;e.set.events.push({kind:"point",at:new Date().toISOString(),winner:t,rotated:s,ctx:L(r,n)}),p(),u()}function Kt(t,e){const n=O();if(!n)return;const r=g(),s=h(n.set),a=s.lineup[t];if(a===e){o.modal=null,u();return}if(ft(s.lineup).has(e)){m("That player is already on court");return}const i=r.get(a),l=r.get(e);!i||!l||(n.set.events.push({kind:"sub",at:new Date().toISOString(),position:t,out:S(i),in:S(l),ctx:L(s,r)}),o.modal=null,p(),u())}function rt(){const t=O();!t||t.set.events.length===0||(t.set.events.pop(),p(),u())}function Wt(){const t=O();t&&(t.set.completed=!0,p(),u())}function qt(t){const e=b();if(!e)return;const n=y(e),r=h(n);e.sets.push({setNumber:e.sets.length+1,startingLineup:{...r.lineup},setterId:r.setterId,weServeFirst:t,events:[],completed:!1}),o.modal=null,p(),u()}function Yt(){const t=b();if(t){const e=y(t);e.events.length>0&&(e.completed=!0)}o.activeMatchId=null,o.modal=null,p(),$("home")}function V(t){const e=t.createdAt.slice(0,10),n=(t.opponent||"match").replace(/[^\w.-]+/g,"_");return`volleystats-${e}-${n}.json`}function _(t,e){st(e,z(o.roster,t))}function st(t,e){const n=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),r=URL.createObjectURL(n),s=document.createElement("a");s.href=r,s.download=t,s.click(),URL.revokeObjectURL(r)}function Zt(t){const e=new Map(o.roster.players.map(r=>[r.id,r]));for(const r of t.roster.players)e.has(r.id)||(o.roster.players.push(r),e.set(r.id,r));!o.roster.teamName&&t.roster.teamName&&(o.roster.teamName=t.roster.teamName);const n=new Set(o.matches.map(r=>r.id));for(const r of t.matches)n.has(r.id)||o.matches.push(r);p()}Ot(document.querySelector("#app"));
